...
function Features() {
  return (
    <>
          ...
          <div className="row">
            <div className="col-md-12 wow fadeInUp">
              <div className="page-banner text-center">
                <h1 className="sub-banner-title userTextColor">Features</h1>
                <ul>
                  <li>
                    <a href="/">Home</a>
                  </li>
      ...
      <div className="feature-part site-bg pt-100 pb-10">
        <div className="container">
          <div className="row">
      ...
      <section className="feature-main site-bg ptb-100">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12 flex-align order-r-1 mb-r-30 wow fadeInRight">
              <div className="work-box">
                ...
                <p className="work-des pb-20">
                  We are legit, stable, reliable cryptocurrencies investment
                  platform. We provide a stable network for your investment. We
                  are the Ultimatecoins, we are confident in what we tell our
                  clients.
                </p>
                ...
                <ul className="check-list">
                  ...
                  <li>
                    ...
                    <p>Fast and easy trading platform.</p>
                  </li>
                  <li>
                    <span>
                      <i className="fa fa-check" aria-hidden="true"></i>
                    </span>{' '}
                    <p>Risk free, easy earning and withdrawal.</p>
                  </li>
                </ul>
