...
function AdminModal({
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (userInfo.infoTitle === 'payments') return handlePaymentSubmit
    if (userInfo.infoTitle === 'savingFundings') return handleSavingSubmit
    if (userInfo.infoTitle === 'withdrawals') return handleWithdrawalSubmit
    if (userInfo.infoTitle === 'savingWithdrawals')
      return handleSavingWithdrawalSubmit
  }
